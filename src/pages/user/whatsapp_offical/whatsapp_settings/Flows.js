...
const OfficalFlows = ({ isOpen }) => {
  ...
  const handleAddNewUser = () => {
    navigate('/whatsapp-settings/add-flows');
  };
          ...
          <div className='px-3 w-full'>
            <div className="w-full flex md:flex- bg-white rounded-lg whitespace-nowrap m-0 py-2">
              ...
              <div className={`w-full flex gap-4 pr-4 md:pr-2 justify-end items-center`}>
                ...
                <button className={`py-0 px-3 m-0 text-white rounded-md bg-black text-lg font-medium `} onClick={handleAddNewUser}>
                  Add Flow
                </button>
                {/* } */}
              </div>
