...
const InternationalAPIManage = ({ isOpen }) => {
    ...
    <section className="w-full bg-gray-200  flex justify-center flex-col">
      ...
      <div className="px-3 py-3 ">
        <div className="px-3 py-3 bg-white flex gap-3 flex-col rounded-md">
          <div className="flex  md:justify-start justify-between gap-3 md:flex-col ">
      ...
      <div className="px-3 w-full mb-3">
        <div className=" flex flex-col items-start h-fit bg-[#383387] border-black border rounded-md">
          <p className="w-full py-2 px-3 whitespace-nowrap text-white text-start font-semibold 
          ...
          <div className='py-3 px-3 border-t border-white w-full select-text'>
            ...
            text-xl m-0 flex flex-col px-3 py-3 bg-green-700 gap-4 text-center">
              ...
              <table className="w-full text-white ">
                <thead>
                  <tr className="bg-[#383387] text-white lg:text-[1rem] text-lg ">
                ...
                <tbody>
                  {TableSendMsg.map((item, index) => (
                    <tr key={index} className="border-t-2 lg:text-[1rem] text-lg border-gray-200 hover:bg-[#383372]">
...
export default InternationalAPIManage

const HighlightAPIText = ({ message }) => {
  return (
